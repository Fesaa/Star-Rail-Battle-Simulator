...
public class FirstHalf extends PfBattle {
    ...
    public FirstHalf(List<AbstractCharacter<?>> players, PureFictionBuff buff) {
        ...
        PfWave thirdWave = new PfWave();
        thirdWave.addEnemies(true,   1012010, 1002030, 100402014, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030, 1012010, 1002030);

        this.addWave(firstWave);
        this.addWave(secondWave);
        this.addWave(thirdWave);
    }
